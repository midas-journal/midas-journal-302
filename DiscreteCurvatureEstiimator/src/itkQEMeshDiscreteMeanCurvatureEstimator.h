#ifndef __itkQEMeshDiscreteMeanCurvatureEstimator_h
#define __itkQEMeshDiscreteMeanCurvatureEstimator_h
...
{
/**
 * \class QEMeshDiscreteMeanCurvatureEstimator
...
{
public:
  typedef QEMeshDiscreteMeanCurvatureEstimator Self;
  ...
  itkTypeMacro( QEMeshDiscreteMeanCurvatureEstimator,
...
protected:
  QEMeshDiscreteMeanCurvatureEstimator() : Superclass() {}
  ~QEMeshDiscreteMeanCurvatureEstimator() {}
...
private:
  QEMeshDiscreteMeanCurvatureEstimator( const Self& );
