#ifndef __itkQEMeshDiscretePrincipalCurvaturesEstimator_h
#define __itkQEMeshDiscretePrincipalCurvaturesEstimator_h
...
{
/**
 * \class QEMeshDiscretePrincipalCurvaturesEstimator
 * \brief
*/
...
{
public:
  typedef QEMeshDiscretePrincipalCurvaturesEstimator Self;
  typedef SmartPointer< Self > Pointer;
  typedef SmartPointer< const Self > ConstPointer;
  typedef QEMeshDiscreteCurvatureEstimator< TInputMesh, TOutputMesh > Superclass;
  ...
  itkTypeMacro( QEMeshDiscretePrincipalCurvaturesEstimator,
    QEMeshDiscreteCurvatureEstimator );
    
  typedef ConformalMatrixCoefficients< OutputMeshType > CoefficientType;

protected:
  QEMeshDiscretePrincipalCurvaturesEstimator() : Superclass(), 
...
private:
  QEMeshDiscretePrincipalCurvaturesEstimator( const Self& );
